...
class Model():
    ...
    def selection(self, network, X_train, X_val, y_train, y_val, params):
        ...
        if network == 'tfidf':
            ...
            raise ValueError('Please select only \'bow\', \'lstm\', \
    ...
    def predict_tweet(self, tweetDF, modelfile, tokenizerfile):
        '''
        params:
        ...
        Returns individual sentiment score for each tweet dataframe
        '''
        ...
        try:
            ...
            output = pd.concat([tweetDF, sentimentDF.sentiment], axis=1)
            return output
    ...
    # give a parameter to output then the csv file.
